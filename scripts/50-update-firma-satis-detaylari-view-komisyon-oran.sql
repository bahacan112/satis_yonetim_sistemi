...
-- Acente komisyonunu yüzde olarak hesapla
((msk.adet * msk.birim_fiyat) * msk.acente_komisyonu / 100.0) AS acente_komisyonu,
msk.rehber_komisyonu AS rehber_komisyonu,
msk.kaptan_komisyonu AS kaptan_komisyonu,
-- Ofis komisyonunu yüzde olarak hesapla
((msk.adet * msk.birim_fiyat) * msk.ofis_komisyonu / 100.0) AS ofis_komisyonu,
