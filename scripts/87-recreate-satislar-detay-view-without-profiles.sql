-- scripts/87-recreate-satislar-detay-view-without-profiles.sql

-- Tip uyumsuzluğu sorununu çözmek için profiles birleştirmesini çıkararak
-- satislar_detay_view'i yeniden oluşturuyoruz.
...
-- satislar_detay_view'i profiles birleştirmesi olmadan yeniden oluştur
...
SELECT
    ...
    s.rehber_id,
    NULL::text AS rehber_adi, -- Şimdilik NULL olarak bırakıyoruz
    sk.urun_id,
    mu.urun_adi,
    sk.adet,
    sk.birim_fiyat,
