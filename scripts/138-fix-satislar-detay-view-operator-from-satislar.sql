-- Satislar detay view'ını operatör bilgisini satislar tablosundan alacak şekilde düzelt

-- Önce mevcut view'ı düşür
DROP VIEW IF EXISTS public.satislar_detay_view CASCADE;

-- View'ı yeniden oluştur - operatör bilgisini satislar tablosundan al
...
SELECT
    ...
    s.rehber_id,
    r.rehber_adi,
    -- Operatör bilgisini satislar tablosundan al
    s.operator_id,
    o.operator_adi,
...
LEFT JOIN
    public.operatorler o ON s.operator_id = o.id -- Operatör join'i satislar tablosu üzerinden
LEFT JOIN
...
-- View'a yorum ekle
COMMENT ON VIEW public.satislar_detay_view IS 'Satış detayları view - operatör bilgisi satislar tablosundan alınır';
