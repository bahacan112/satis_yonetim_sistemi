-- scripts/132-recreate-magaza-muhasebe-satis-detay-view.sql
-- Recreate magaza_muhasebe_satis_detay_view to properly show data

-- Drop the existing view
DROP VIEW IF EXISTS public.magaza_muhasebe_satis_detay_view;

-- Create the corrected magaza_muhasebe_satis_detay_view
