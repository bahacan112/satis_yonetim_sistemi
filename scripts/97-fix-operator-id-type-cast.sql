-- scripts/97-fix-operator-id-type-cast.sql
...
-- Step 2: Recreate satislar_detay_view with correct toplam_tutar calculation and operator_id type cast
...
LEFT JOIN public.operatorler o ON s.operator_id::uuid = o.id -- operator_id'yi UUID'ye dönüştür
