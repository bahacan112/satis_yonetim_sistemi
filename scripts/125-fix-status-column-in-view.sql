-- scripts/125-fix-status-column-in-view.sql
-- Bu script, magaza_muhasebe_satis_detay_view görünümünü yeniden oluşturur.
-- status sütununun satislar tablosundan değil, magaza_satis_kalemleri tablosundan alınmasını sağlar.
...
SELECT
    ...
    s.grup_pax,
    s.magaza_pax,
    msk.status, -- status sütunu artık msk tablosundan alınıyor
    m.id AS magaza_id,
    m.magaza_adi,
