...
-- satislar_detay_view'i yeni status sütunu ile yeniden oluştur
...
-- magaza_muhasebe_summary_view'i düzeltilmiş tahsilat sütunu ile yeniden oluştur
...
tahsilat_toplamlari AS (
    SELECT
        t.magaza_id,
        SUM(t.amount) AS toplam_tahsilat -- 'tutar' sütunu 'amount' olarak değiştirildi
    FROM
        tahsilatlar t
    GROUP BY
        t.magaza_id
