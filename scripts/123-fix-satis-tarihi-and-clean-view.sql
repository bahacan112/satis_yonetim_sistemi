-- scripts/123-fix-satis-tarihi-and-clean-view.sql
-- Bu script, magaza_muhasebe_satis_detay_view görünümünü yeniden oluşturur.
-- satis_tarihi sütununu satislar tablosundaki magaza_giris_tarihi sütunundan alır.
-- Ayrıca, bekleme sütunu artık satislar tablosunda olmadığı için görünümden kaldırılır.
