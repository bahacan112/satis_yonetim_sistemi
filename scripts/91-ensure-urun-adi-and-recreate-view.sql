-- scripts/91-ensure-urun-adi-and-recreate-view.sql
...
BEGIN
    ...
    ELSE
        RAISE NOTICE 'Column firma_adi already exists in firmalar table.'; -- Düzeltme burada: RAASE -> RAISE
    END IF;
END
$$;
